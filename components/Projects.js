...
const Projects = () => {
  return (
    <div className='flex justify-center flex-col p-4 md:max-w-4xl md:mx-auto' id="projects">
        <span className='text-4xl text-white font-bold mx-5 mt-10 mb-2 text-center md:text-left'>Some Projects</span>
        <span className='text-white mx-5 my-2 text-center'>All code on my <a className="underline" href="https://github.com/JpLagos" target="_blank" rel="noopener noreferrer">GitHub Repo</a></span>
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-white mx-auto sm:mx-0'>     
