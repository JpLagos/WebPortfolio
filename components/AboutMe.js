  ...
  return (
    <div id="about">
        <div className='flex flex-col md:max-w-4xl md:mx-auto'>
            ...
            <span className='mx-5 text-white py-2'>Anyway, Thanks for reading. If i have bored you, <a href="https://benevolent-dieffenbachia-a98e11.netlify.app/" target="_blank" className='underline text-white cursor-pointer'>click here and let's fix it!.</a>  </span>
        </div>
    </div>
  )
}
